...
map.on('load', function loadingData() {
    ...
    legend.innerHTML = "<b>Covid-19 Rates<br>(pos tests/total tests)</b><br><br>";
...
map.on('mousemove', ({point}) => {
    ...
    document.getElementById('text-escription').innerHTML = covid.length ?
        `<h3>${covid[0].properties.county}</h3><p><strong><em>${covid[0].properties.rates}</strong> pos cases/total cases</em></p>` :
